...
function download() {
    ...
    wget -N http://$SOURCE_IP:$PORT/shared/release/hospital-in/ywx/${VERSION}/pkg/gateway.jar
    wget -N http://$SOURCE_IP:$PORT/shared/release/hospital-in/ywx/${VERSION}/pkg/hisca.jar
